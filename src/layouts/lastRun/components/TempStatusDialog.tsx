...
import {tempLastColumns} from "../../../project-columns";
        ...
        <CustomMUIDialog handleClose={handleClose} title={title} open={open}>
            {
                props.loading ? <div style={{margin: "auto", display: 'table'}}>
                    ...
                    <CustomMUIGrid data={props.data} columns={tempLastColumns}
...
export default TempStatusDialog;
